// Default to deployed backend; override via VITE_API_BASE_URL for local dev
export const API_BASE_URL = (import.meta as any)?.env?.VITE_API_BASE_URL || 'https://user-registration-taupe-seven.vercel.app';
